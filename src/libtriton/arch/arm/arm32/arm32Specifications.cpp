  ...
  namespace arch {
    namespace arm {
      namespace arm32 {
        ...
        triton::uint32 Arm32Specifications::capstoneInstructionToTritonInstruction(uint64 id, bool is_alias) const {
          triton::uint32 tritonId = triton::arch::arm::arm32::ID_INS_INVALID;

          if (is_alias) {
            switch (id) {
              case triton::extlibs::capstone::ARM_INS_ALIAS_NOP:
                tritonId = triton::arch::arm::arm32::ID_INS_NOP;
                break;

              case triton::extlibs::capstone::ARM_INS_ALIAS_YIELD:
                tritonId = triton::arch::arm::arm32::ID_INS_YIELD;
                break;

              case triton::extlibs::capstone::ARM_INS_ALIAS_WFE:
                tritonId = triton::arch::arm::arm32::ID_INS_WFE;
                break;

              case triton::extlibs::capstone::ARM_INS_ALIAS_WFI:
                tritonId = triton::arch::arm::arm32::ID_INS_WFI;
                break;

              case triton::extlibs::capstone::ARM_INS_ALIAS_SEV:
                tritonId = triton::arch::arm::arm32::ID_INS_SEV;
                break;

              case triton::extlibs::capstone::ARM_INS_ALIAS_SEVL:
                tritonId = triton::arch::arm::arm32::ID_INS_SEVL;
                break;

              case triton::extlibs::capstone::ARM_INS_ALIAS_VPUSH:
                tritonId = triton::arch::arm::arm32::ID_INS_VPUSH;
                break;

              case triton::extlibs::capstone::ARM_INS_ALIAS_VPOP:
