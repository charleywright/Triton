...
// Vector Register
REG_SPEC(Z0,  z0,  triton::bitsize::dqword-1, 0, Z0,  TT_MUTABLE_REG) // z0
REG_SPEC(Z1,  z1,  triton::bitsize::dqword-1, 0, Z1,  TT_MUTABLE_REG) // z1
REG_SPEC(Z2,  z2,  triton::bitsize::dqword-1, 0, Z2,  TT_MUTABLE_REG) // z2
REG_SPEC(Z3,  z3,  triton::bitsize::dqword-1, 0, Z3,  TT_MUTABLE_REG) // z3
REG_SPEC(Z4,  z4,  triton::bitsize::dqword-1, 0, Z4,  TT_MUTABLE_REG) // z4
REG_SPEC(Z5,  z5,  triton::bitsize::dqword-1, 0, Z5,  TT_MUTABLE_REG) // z5
REG_SPEC(Z6,  z6,  triton::bitsize::dqword-1, 0, Z6,  TT_MUTABLE_REG) // z6
REG_SPEC(Z7,  z7,  triton::bitsize::dqword-1, 0, Z7,  TT_MUTABLE_REG) // z7
REG_SPEC(Z8,  z8,  triton::bitsize::dqword-1, 0, Z8,  TT_MUTABLE_REG) // z8
REG_SPEC(Z9,  z9,  triton::bitsize::dqword-1, 0, Z9,  TT_MUTABLE_REG) // z9
REG_SPEC(Z10, z10, triton::bitsize::dqword-1, 0, Z10, TT_MUTABLE_REG) // z10
REG_SPEC(Z11, z11, triton::bitsize::dqword-1, 0, Z11, TT_MUTABLE_REG) // z11
REG_SPEC(Z12, z12, triton::bitsize::dqword-1, 0, Z12, TT_MUTABLE_REG) // z12
REG_SPEC(Z13, z13, triton::bitsize::dqword-1, 0, Z13, TT_MUTABLE_REG) // z13
REG_SPEC(Z14, z14, triton::bitsize::dqword-1, 0, Z14, TT_MUTABLE_REG) // z14
REG_SPEC(Z15, z15, triton::bitsize::dqword-1, 0, Z15, TT_MUTABLE_REG) // z15
REG_SPEC(Z16, z16, triton::bitsize::dqword-1, 0, Z16, TT_MUTABLE_REG) // z16
REG_SPEC(Z17, z17, triton::bitsize::dqword-1, 0, Z17, TT_MUTABLE_REG) // z17
REG_SPEC(Z18, z18, triton::bitsize::dqword-1, 0, Z18, TT_MUTABLE_REG) // z18
REG_SPEC(Z19, z19, triton::bitsize::dqword-1, 0, Z19, TT_MUTABLE_REG) // z19
REG_SPEC(Z20, z20, triton::bitsize::dqword-1, 0, Z20, TT_MUTABLE_REG) // z20
REG_SPEC(Z21, z21, triton::bitsize::dqword-1, 0, Z21, TT_MUTABLE_REG) // z21
REG_SPEC(Z22, z22, triton::bitsize::dqword-1, 0, Z22, TT_MUTABLE_REG) // z22
REG_SPEC(Z23, z23, triton::bitsize::dqword-1, 0, Z23, TT_MUTABLE_REG) // z23
REG_SPEC(Z24, z24, triton::bitsize::dqword-1, 0, Z24, TT_MUTABLE_REG) // z24
REG_SPEC(Z25, z25, triton::bitsize::dqword-1, 0, Z25, TT_MUTABLE_REG) // z25
REG_SPEC(Z26, z26, triton::bitsize::dqword-1, 0, Z26, TT_MUTABLE_REG) // z26
REG_SPEC(Z27, z27, triton::bitsize::dqword-1, 0, Z27, TT_MUTABLE_REG) // z27
REG_SPEC(Z28, z28, triton::bitsize::dqword-1, 0, Z28, TT_MUTABLE_REG) // z28
REG_SPEC(Z29, z29, triton::bitsize::dqword-1, 0, Z29, TT_MUTABLE_REG) // z29
REG_SPEC(Z30, z30, triton::bitsize::dqword-1, 0, Z30, TT_MUTABLE_REG) // z30
REG_SPEC(Z31, z31, triton::bitsize::dqword-1, 0, Z31, TT_MUTABLE_REG) // z31
